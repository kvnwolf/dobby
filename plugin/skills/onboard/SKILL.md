...
- [ ] Interviewed: product, domain terms, stack (docs confirmed via /find-docs), `run_mode` (singletons? → concurrent/nonconcurrent), issue tracker (github default / linear / local, via AskUserQuestion), greenfield-or-existing

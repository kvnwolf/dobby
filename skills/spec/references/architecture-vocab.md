...
- **One public interface per module.** Callers import only through the module's entry point; everything else stays private. The interface sits at the top and explains what the module does.
